...
public class TestMissionActivity extends AppCompatActivity implements MissionView, OnMapReadyCallback,
        GoogleMap.OnMarkerClickListener {

    private TestMissionPresenter presenter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.presenter = new TestMissionPresenterImpl(this);
