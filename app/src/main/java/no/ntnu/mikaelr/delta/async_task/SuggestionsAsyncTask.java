...
public class SuggestionsAsyncTask extends AsyncTask<Void, Void, Pair<Integer, ResponseEntity<String>>> {

    private String request;
    private ProjectInteractorImpl.OnFinishedLoadingSuggestionsListener listener;

    public SuggestionsAsyncTask(String request, ProjectInteractorImpl.OnFinishedLoadingSuggestionsListener listener) {
