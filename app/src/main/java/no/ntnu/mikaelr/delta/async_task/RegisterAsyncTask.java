...
public class RegisterAsyncTask extends AsyncTask<Void, Void, Pair<Integer, ResponseEntity<String>>> {
    ...
    public RegisterAsyncTask(String request, String username, String password, String registerCode, LoginInteractorImpl.OnRegisterListener listener) {
