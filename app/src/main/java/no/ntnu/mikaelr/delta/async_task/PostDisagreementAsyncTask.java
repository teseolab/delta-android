...
public class PostDisagreementAsyncTask extends AsyncTask<Void, Void, Pair<Integer, ResponseEntity<String>>> {

    private String request;
    private ProjectInteractorImpl.OnPostDisagreementListener listener;

    public PostDisagreementAsyncTask(String request, ProjectInteractorImpl.OnPostDisagreementListener listener) {
    ...
    protected Pair<Integer, ResponseEntity<String>> doInBackground(Void... params) {
        ...
        try {
            ResponseEntity<String> result = template.exchange(request, HttpMethod.POST, entity, String.class);
