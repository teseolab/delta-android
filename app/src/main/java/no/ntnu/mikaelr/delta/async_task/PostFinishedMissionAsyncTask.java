...
public class PostFinishedMissionAsyncTask extends AsyncTask<Void, Void, Pair<Integer, ResponseEntity<String>>> {

    private String request;
    private ProjectInteractorImpl.OnPostFinishedMission listener;

    public PostFinishedMissionAsyncTask(String request, ProjectInteractorImpl.OnPostFinishedMission listener) {
